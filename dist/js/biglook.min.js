...
var magnifyingGlass = function magnifyingGlass() {
  ...
  this["float"] = document.getElementById("docu"); // 给遮罩层添加滑过事件
  // 滑过时  大盒子出现 滑块出现
  // 计算出鼠标的当前相对坐标值
  // 设置鼠标跟随
  ...
  this.cover.onmousemove = function (eve) {
    ...
    this["float"].style.display = 'block'; // 获取鼠标坐标
    ...
    this.top = this.dis_top - this["float"].offsetHeight / 2; // 设置边界
    ...
    this["float"].style.top = this.top + 'px'; // 放大核心
  ...
  }.bind(this); // 给一个鼠标划出事件， 划出时 滑块 大盒子消失
