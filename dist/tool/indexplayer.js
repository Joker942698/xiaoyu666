(function () {
    ...
    Slider.prototype.createDom = function () {
        ...
        this.imgList.forEach(function (item) {
            var oLi = (`<li style="background: url(${item.img}) no-repeat scroll center center / cover;;width: 100%; height: 480px;">
        </li>`);
            oUl.append(oLi);
            var span = ('<span></span>');
            Spot.append(span);
        ...
        var rightBtn = $('<div class="right-btn" style="display: none;">&gt</div>');
